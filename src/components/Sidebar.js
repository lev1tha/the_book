import { Stethoscope, List, LayoutDashboard, Users, ClipboardList } from "lucide-react";
import { todayStr } from "../utils";

export function Sidebar({ page, go, patients }) {
  ...
  const nav = [
    ...
    { id: "queue",     icon: <List size={17} />,             label: "Очередь", badge: todayWaiting > 0 ? todayWaiting : null },
